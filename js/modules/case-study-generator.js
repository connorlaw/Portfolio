  ...
  constructor() {
    this.preFillOptions = {
      'techscheme': {
        ...
        'tools': ['Adobe-XD', 'Github', 'Sass', 'CSS', 'JavaScript', 'Notion', 'Photoshop', 'HTML'],
        'testimonial': 'gio',
      ...
      'cyclescheme': {
        ...
        'tools': ['Adobe-XD', 'Github', 'Sass', 'CSS', 'JavaScript', 'Photoshop', 'HTML', 'Angular', 'PHP', 'Illustrator'],
      ...
      'myeyesite': {
        ...
        'tools': ['Sass', 'HTML', 'Angular', 'Illustrator', 'CSS', 'Adobe-XD', 'Github', 'JavaScript'],
        'testimonial': 'nick',
      ...
      'bicycle-association': {
        ...
        'tools': ['Wordpress', 'Adobe-XD', 'HTML', 'Github', 'Sass', 'Illustrator', 'JavaScript', 'CSS', 'PHP'],
        'testimonial': 'sam',
            ...
            <div class="section__inner">
              <div class="socials">
                  <a target="_blank" href="https://codepen.io/connorlaw" rel="noopener noreferrer">
                      <img height="32" width="32" alt="Codepen logo" class="social" src="../images/logos/logo_codepen.svg" alt="Codepen logo">
                  </a>
